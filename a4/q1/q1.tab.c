...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_func_declaration = 8            /* func_declaration  */
};
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "IDENTIFIER", "$accept", "program", "func_declaration", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* func_declaration: FUNCTION IDENTIFIER SEMICOLON  */
#line 70 "q1.y"
    {
        FuncDecl((yyvsp[-1].sval));
        free((yyvsp[-1].sval));
    }
#line 1107 "q1.tab.c"
    break;
